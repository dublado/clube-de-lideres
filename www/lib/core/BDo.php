...
define('DB_DRIVER'	, isset($dbconfig[Ambiente]['driver'])  ?  $dbconfig[Ambiente]['driver']  : die('Defina o driver correto para o ambiente '.Ambiente.' em /config.php') );
define('DB_HOST'	, isset($dbconfig[Ambiente]['host'])  ?  $dbconfig[Ambiente]['host']      : die('Defina o host correto para o ambiente '.Ambiente.' em /config.php') );
define('DB_NAME'	, isset($dbconfig[Ambiente]['db'])  ?  $dbconfig[Ambiente]['db']          : die('Defina o db correto em para o ambiente '.Ambiente.' /config.php') );
define('DB_USER'	, isset($dbconfig[Ambiente]['user'])  ?  $dbconfig[Ambiente]['user']      : die('Defina o user correto em para o ambiente '.Ambiente.' /config.php') );
define('DB_PASS'	, isset($dbconfig[Ambiente]['pass'])  ?  $dbconfig[Ambiente]['pass']      : die('Defina o pass correto em para o ambiente '.Ambiente.' /config.php') );
